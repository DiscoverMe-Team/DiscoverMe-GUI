        ...
        <div id="home" class="landing-wrapper overflow-hidden">
            ...
            <div
                ...
                <div class="mx-6 md:mx-20 mt-0 md:mt-6">
                    <h1 class="text-6xl font-bold text-gray-900 leading-tight"><span class="font-light block">Welcome</span>Discover a better you!</h1>
                    <p class="font-normal text-2xl leading-normal md:mt-4 text-gray-700">Start your mental health journey with DiscoverMe</p>
                    <Button label="Get Started" as="router-link" to="/" rounded class="!text-xl mt-8 !px-4"></Button>
                </div>
                <div class="flex justify-center md:justify-end">
                    <img src=/demo/images/DiscoverMe-Image.jpg alt="Hero Image" class="w-9/12 md:w-auto" style="max-width: 20%;" />
                </div>
            </div>
            ...
            <div id="about" class="py-6 px-6 lg:px-20 mx-0 my-12 lg:mx-20">
                <div class="text-center">
                    ...
                    <span class="text-muted-color text-2xl">What is DisoverMe?</span>
                </div>
                ...
                <div class="grid grid-cols-12 gap-4 mt-20 pb-2 md:pb-20">
                    ...
                    <div class="col-span-12 lg:col-span-6 my-auto flex flex-col lg:items-end text-center lg:text-right gap-4">
                        <div class="flex items-center justify-center bg-purple-200 self-center lg:self-end" style="width: 4.2rem; height: 4.2rem; border-radius: 10px">
                            <i class="pi pi-fw pi-compass !text-4xl text-purple-700"></i>
                        </div>
                        <div class="leading-none text-surface-900 dark:text-surface-0 text-3xl font-normal">DiscoverMe is a web-based Mood & Mental Health Tracker designed to help society log their moods, track emotional trends, and receive personalized recommendations for mental well-being. </div>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                        ...
                        >
                            <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <span class="text-surface-600 dark:text-surface-200">A safe space for all of your thoughts.</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pb-8 mt-6 lg:mt-0">
                        ...
                        >
                            <div class="p-4 bg-surface-0 dark:bg-surface-900 h-full" style="border-radius: 8px">
                                ...
                                <div class="mt-6 mb-1 text-surface-900 dark:text-surface-0 text-xl font-semibold">Goal Setting</div>
